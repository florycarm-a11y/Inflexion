...
var SEMPLICE_ZONES=[
    {id:'ormuz',name:'Détroit d\'Ormuz',
     scores:[4.4,5.7,6.2,6.7,6.9,6.9,6.5,5.2],composite:6.1,level:'Critique',
    ...
    {id:'sahel',name:'Sahel',
     ...
     opp:[2.2,3.3,2.2,1.9,2.8,2.0,2.2,3.0],oppComposite:2.5,oppLevel:'Faible',
    ...
    {id:'ukraine',name:'Ukraine / Mer Noire',
     scores:[5.6,5.7,6.6,5.4,4.7,5.8,6.3,4.6],composite:5.7,level:'Très élevé',
     opp:[4,3,1,3,3,5,4,3],oppComposite:3.4,oppLevel:'Modéré',
    ...
    {id:'cuba',name:'Cuba',
     scores:[3.8,6.0,3.3,5.6,5.9,5.6,4.2,4.1],composite:4.8,level:'Élevé',
    ...
    {id:'chine',name:'Mer de Chine',
     scores:[3.5,3.6,4.7,5.0,3.9,6.9,5.0,3.9],composite:4.6,level:'Élevé',
     opp:[5.0,5.9,4.2,3.1,4.1,6.2,5.9,4.9],oppComposite:5.0,oppLevel:'Significatif',
    ...
    {id:'bresil',name:'Brésil',
     ...
     opp:[4.5,5.5,3.5,3.5,3.0,4.0,4.5,5.5],oppComposite:4.3,oppLevel:'Significatif',
    ...
    {id:'tamil',name:'Tamil Nadu',
     ...
     opp:[5.5,6.0,4.5,4.5,3.0,5.5,5.0,4.5],oppComposite:4.9,oppLevel:'Significatif',
    ...
    {id:'arctique',name:'Arctique',
     ...
     opp:[5.3,5.2,4.6,6.1,5.9,5.2,6.2,6.2],oppComposite:5.6,oppLevel:'Élevé',
    ...
    {id:'ile-maurice',name:'Île Maurice',
     scores:[2.4,2.3,1.2,2.2,2.2,2.4,3.2,3.8],composite:2.4,level:'Modéré-Faible',
    ...
    {id:'singapour',name:'Singapour',
     ...
     opp:[5,5,5,6,6,6,6,4],oppComposite:5.4,oppLevel:'Élevé',
    ...
    {id:'republique-tcheque',name:'République tchèque',
     ...
     opp:[5.4,3.9,4.8,5.5,5.0,3.9,5.1,4.0],oppComposite:4.7,oppLevel:'Significatif',
    ...
    {id:'ethiopie',name:'Éthiopie',
     ...
     opp:[2.6,3.6,3.0,2.7,2.8,1.9,1.9,3.0],oppComposite:2.7,oppLevel:'Faible',
