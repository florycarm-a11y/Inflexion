...
function setupLoadingFallbacks() {
    setTimeout(function() {
        ...
        document.querySelectorAll('.loading').forEach(function(loader) {
            ...
            if (id === 'top-stories') {
                message = 'Articles à la une en cours de récupération — 178 sources analysées toutes les 6h.';
            } else if (id === 'latest-news') {
                message = 'Actualités en cours de chargement — nos 15 APIs et 163 flux RSS sont interrogés régulièrement.';
