// Inflexion — v4.2 — New sources + xAI/SpaceX + Anthropic + stablecoins
...
const newsDatabase = {
    ...
    markets: [
        { source: 'SpaceX', url: 'https://www.spacex.com/updates#xai-joins-spacex', title: 'xAI rejoint SpaceX : Musk fusionne IA et aérospatiale', description: 'SpaceX annonce l\'intégration de xAI dans son organisation. La collaboration vise à combiner recherche IA avancée et ingénierie aérospatiale — systèmes autonomes, robotique spatiale, et exploration. Un alignement stratégique IA + hardware qui redéfinit les ambitions de l\'empire Musk.', tags: ['markets'], time: '4 fév.', impact: 'high' },
