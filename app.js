...
const categoryTrends = {
    ...
    markets: 'Régime de volatilité élevée dominé par deux forces : risque tarifaire et essor de l\'IA. Le VIX repasse au-dessus de 20. Les Sept Magnifiques pèsent plus de 30 % du S&P 500 — sans ces 7 titres, l\'indice serait négatif depuis janvier. Nvidia (57 Mds$ de CA au T3, +62 % sur un an) reste le seul pilier haussier crédible. Côté emploi, gel des embauches confirmé : seulement 584 000 créations de postes en 2025, pire année hors récession depuis 2003. Mais les offres mentionnant l\'IA sont à +134 % par rapport à 2020 (Indeed). 89 % des DRH prévoient que l\'IA transformera les postes en 2026. Le FMI avertit : l\'IA frappe le marché du travail « comme un tsunami ». Les banques mondiales pourraient supprimer 200 000 postes en 3-5 ans (Bloomberg Intelligence). Positionnement : stratégie haltère IA + couvertures défensives.',
