...
HISTORICAL_EVENTS: list[BacktestEvent] = [
    ...
    # ── Événements outcome=False (équilibrage du dataset) ─────────────
    BacktestEvent(
        id="china-invade-taiwan-2023",
        question="Will China invade Taiwan in 2023?",
        zone_id="chine",
        entry_date="2023-01-01",
        end_date="2023-12-31",
        outcome=False,
        poly_price_at_open=0.03,
        description="Pas d'invasion — tensions mais pas d'escalade militaire directe",
    ),
    BacktestEvent(
        id="iran-nuclear-weapon-2023",
        question="Will Iran develop a nuclear weapon by end of 2023?",
        zone_id="iran",
        entry_date="2023-01-01",
        end_date="2023-12-31",
        outcome=False,
        poly_price_at_open=0.06,
        description="Programme nucléaire avancé mais pas de weaponisation confirmée",
    ),
    BacktestEvent(
        id="russia-nuclear-use-2022",
        question="Will Russia use a nuclear weapon in 2022?",
        zone_id="ukraine",
        entry_date="2022-03-01",
        end_date="2022-12-31",
        outcome=False,
        poly_price_at_open=0.10,
        description="Menaces nucléaires répétées mais aucune utilisation",
    ),
    BacktestEvent(
        id="turkey-leave-nato-2023",
        question="Will Turkey leave NATO in 2023?",
        zone_id="turquie",
        entry_date="2023-01-01",
        end_date="2023-12-31",
        outcome=False,
        poly_price_at_open=0.04,
        description="Tensions avec l'Alliance mais aucune procédure de retrait",
    ),
    BacktestEvent(
        id="brazil-coup-2023",
        question="Will the Brazilian military launch a coup in 2023?",
        zone_id="bresil",
        entry_date="2023-01-01",
        end_date="2023-12-31",
        outcome=False,
        poly_price_at_open=0.08,
        description="Insurrection bolsonariste écrasée, armée loyale à Lula",
    ),
    BacktestEvent(
        id="india-pakistan-war-2024",
        question="Will India and Pakistan go to war in 2024?",
        zone_id="inde",
        entry_date="2024-01-01",
        end_date="2024-12-31",
        outcome=False,
        poly_price_at_open=0.05,
        description="Tensions au Cachemire mais pas d'escalade en conflit ouvert",
    ),
    BacktestEvent(
        id="sahel-ecowas-collapse-2024",
        question="Will ECOWAS collapse or dissolve in 2024?",
        zone_id="sahel",
        entry_date="2024-01-01",
        end_date="2024-12-31",
        outcome=False,
        poly_price_at_open=0.15,
        description="AES (Mali/Niger/Burkina) quittent mais ECOWAS survit",
    ),
    BacktestEvent(
        id="iran-israel-full-war-2024",
        question="Will Iran and Israel engage in a full-scale war in 2024?",
        zone_id="iran",
        entry_date="2024-01-01",
        end_date="2024-12-31",
        outcome=False,
        poly_price_at_open=0.20,
        description="Frappes limitées réciproques mais pas de guerre totale",
    ),
    BacktestEvent(
        id="arctic-military-clash-2024",
        question="Will there be a military confrontation in the Arctic in 2024?",
        zone_id="arctique",
        entry_date="2024-01-01",
        end_date="2024-12-31",
        outcome=False,
        poly_price_at_open=0.04,
        description="Remilitarisation accrue mais aucun affrontement direct",
    ),
    BacktestEvent(
        id="cuba-regime-change-2024",
        question="Will the Cuban government fall or undergo regime change in 2024?",
        zone_id="cuba",
        entry_date="2024-01-01",
        end_date="2024-12-31",
        outcome=False,
        poly_price_at_open=0.05,
        description="Crise économique grave mais régime maintenu",
    ),
]
